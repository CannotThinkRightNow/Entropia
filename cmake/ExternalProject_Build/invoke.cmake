...
if (EXTERNALPROJECT_BUILD_NO_DEV)
  list(APPEND EXTERNALPROJECT_BUILD_ARGS "-Wno-dev -Wno-error=dev -Wno-error=deprecated")
endif ()
...
execute_process(COMMAND ${CMAKE_COMMAND} --build "${EXTERNALPROJECT_BUILD_PREFIX}" --config ${CMAKE_BUILD_TYPE} ${EXTERNALPROJECT_BUILD_BUILD_ARGS})
...
unset(EXTERNALPROJECT_BUILD_NO_DEV)
