...
if ($ENV{GITHUB_PERSONAL_READONLY_TOKEN})
  set(GLFW_GITHUB_API_HTTPHEADER "${GLFW_GITHUB_API_HTTPHEADER}\nAuthorization: token $ENV{GITHUB_PERSONAL_READONLY_TOKEN}")
endif ()
file(DOWNLOAD "https://api.github.com/repos/glfw/glfw" ${GLFW_REPO_JSON} TLS_VERIFY ON HTTPHEADER "${GLFW_GITHUB_API_HTTPHEADER}")
